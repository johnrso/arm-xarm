...
class XArm(RobotModelFromURDF):
    ...
    def reset_pose(self):
        av = [
            ...
            #1.47, 0.42, -2.0, 1.75, 0.45, 1.9, -0.4
            # 1.85, 0.46, -1.74, 1.56, 0.42, 1.62, -1.37,
            # .506, -.325, .097, 2.503, -.0173, 2.100, 0.00525
            # 0.153, -1.099, 0.131, 1.314, 0.138, 1.721, .177
            # -.0105, -1.161, .0607, 1.322, .1504, 1.4400, .0886
            # 0, -1.2217, 0, 1.3963, 0, 1.3963, 0 # kitchen pose
            0, -1.22, 0, 1.396, 0 , 1.97, 0 # bag pose
        ]
