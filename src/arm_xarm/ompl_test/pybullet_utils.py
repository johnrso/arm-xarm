...
def get_collision_file(visual_file, resolution=200000):
    ...
    if not collision_file.exists():
        #p.vhacd(visual_file, collision_file, '/tmp/testVHACD.log', alpha=0.04, resolution=resolution)
        p.vhacd(visual_file, collision_file, '/tmp/testVHACD.log', alpha=0.2, resolution=resolution)
        # cmd = (
